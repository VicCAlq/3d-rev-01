...
o nome desta variável. O tipo da variável deve combinar com o conteúdo, exemplo:
Se o nome da variável é um número, o valor dela deve ser um número. Por aí vai.
...
/* Questão 01 */
export let musicaFavorita = //"D˃E˃A˃T˃H˃M˃E˃T˃A˃L"


/* Questão 02 */
export let objetoQualquer = const carro = {};




/* Questão 03 */
export let valorIndefinido = const pessoa = {idade:30} console.log(pessoa.endereco);
...
/* Questão 07 */
export let umaFuncao = //function casa()
...
/* Questão 14 */
export let artistaFavorito = "Monet"
...
/* Questão 16 */
export let umMaiorQueDoisVerdadeOuNao = true


/* Questão 17 */
export let comidaFavorita = "sushi"
