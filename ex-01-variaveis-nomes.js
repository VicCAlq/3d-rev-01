...
/* Questão 08 */
export let rodas$4 = true

/* Questão 09 */
export let powerRangers5 = true

/* Questão 10 */
export let puro_Aco = true

/* Questão 11 */
export const reaisEmBarrasDeOuro$100 = true

/* Questão 12 */
export const paginaInicial = true

/* Questão 13 */
export let patinhosForamPassear_5 = true

/* Questão 14 */
export class Besouro$1 {}
